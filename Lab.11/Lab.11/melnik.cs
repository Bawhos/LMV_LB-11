...
namespace Lab._11
{
    public partial class melnik : Form
    {
        int i = 0;
        public melnik()
        {
        ...
        {
            MessageBox.Show("Меню розробив студент гр. IПЗ-41  Мельник Максим", "info", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
        }

        private void toolStripButton4_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Web-браузер розробив студент гр. IПЗ-41  Мельник Максим e-mail example.mail@gmail.com", "info", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
        }
        ...
        private void toolStripButton8_Click(object sender, EventArgs e)
        {
            MessageBox.Show("1. Нажимаючи на стрілочку вліво вас повертає на одну сторінку назад. \r " +
                ...
                "4. Нажимаєте на кнопку GO виконується пошук.Нажимаюте на плюс ,відкривається нова вкладка. \r" +
